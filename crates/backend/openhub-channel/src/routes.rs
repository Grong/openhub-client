...
use openhub_extension::{ExtensionRegistry, ResolvedChannelPlugin};
...
/// `x-openhub-local-trust` header, so an SSE stream was rejected 403 by the auth
...
mod tests {
    use super::*;
    use openhub_api_types::TestPluginExtraConfig;
