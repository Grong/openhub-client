...
use openhub_api_types::{PairingRequestedPayload, UserAuthorizedPayload, WebSocketMessage};
use openhub_common::{TimestampMs, generate_prefixed_id, now_ms};
use openhub_db::IChannelRepository;
use openhub_db::models::{AssistantUserRow, PairingCodeRow};
...
mod tests {
    ...
    /// (the assembly in openhub-app now starts it at boot).
