...
use openhub_channel::pending_decision::PendingDecisionStore;
use openhub_channel::stream_relay::{ChannelSender, ChannelStreamRelay, MessageRecorder, RelayConfig};
use openhub_channel::types::{OutgoingMessageType, ParseMode, PluginType};
...
async fn weixin_flushes_pending_text_before_tool_call() {
    // Port of OpenHub TS fix `406a62665` to the backend relay layer. On
