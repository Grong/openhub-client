...
mod weixin_tests {
    ...
    use openhub_channel::manager::{ChannelManager, EnableChannelSpec, PluginFactory};
    use openhub_channel::plugin::ChannelPlugin;
    use openhub_channel::plugins::weixin::WeixinPlugin;
    use openhub_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use openhub_channel::plugins::weixin::weixin_login_stream;
