...
use openhub_ai_agent::{AcpPermissionEventData, AcpPermissionOptionKind, AcpToolCallKind, AgentStreamEvent, TurnStopReason};
use openhub_ai_agent::task_manager::IWorkerTaskManager;
use openhub_api_types::{ConfirmRequest, IdmmTargetKind, SendMessageRequest};
use openhub_common::{AppError, Confirmation};
use openhub_conversation::ConversationService;
use openhub_db::{IConversationRepository, SortOrder};
use openhub_terminal::TerminalDriver;
use tokio::sync::mpsc;
...
/// read-only (or unknown). Mirrors `acp_tool_is_safe` for the openhub/openclaw path.
...
/// Build a structured permission decision from a `Confirmation` (openhub/openclaw
...
fn pending_signal_from_page(extra: &str, messages: &[openhub_db::models::MessageRow]) -> Option<(SessionSignal, i64)> {
...
impl SessionProbe for ConversationProbe {
    ...
    fn observe(&self, idle_threshold: Duration) -> mpsc::Receiver<SessionSignal> {
        ...
        tokio::spawn(async move {
            ...
            let mut work_epoch_ms = openhub_common::now_ms();
                        ...
                        Ok(ev) => {
                            ...
                            if let Some(sig) = sig {
                                if matches!(sig, SessionSignal::Working) {
                                    saw_activity = true;
                                    work_epoch_ms = openhub_common::now_ms();
                                }
    ...
    async fn fallback_model(&self) -> Option<(String, String)> {
        ...
        let pm = openhub_conversation::task_options::provider_model_from_conversation_row(&row);
...
fn map_lifecycle_event(kind: openhub_terminal::LifecycleKind) -> Option<SessionSignal> {
    use openhub_terminal::LifecycleKind;
    match kind {
                ...
                tokio::select! {
                    ...
                    lifecycle_ev = async {
                        match lifecycle_rx.as_mut() {
                            ...
                            None => std::future::pending::<Result<openhub_terminal::TerminalLifecycleEvent, tokio::sync::broadcast::error::RecvError>>().await,
                        }
                    } => {
                        match lifecycle_ev {
                            Ok(ev) => {
                                ...
                                let sig = match ev.kind {
                                    openhub_terminal::LifecycleKind::TurnEnd => Some(terminal_turn_end_signal(&detector)),
...
mod tests {
    use super::*;
    use openhub_api_types::{AgentErrorCode, AgentErrorOwnership, AgentStreamErrorData};
    ...
    fn map_agent_event_finish_cancelled_is_user_cancel_not_done() {
        ...
        let ev = AgentStreamEvent::Finish(openhub_ai_agent::FinishEventData {
            session_id: None,
    ...
    fn confirmation(command_type: &str) -> Confirmation {
        use openhub_common::ConfirmationOption;
        Confirmation {
            id: "c1".into(),
            call_id: "call-1".into(),
    ...
    use openhub_terminal::{TerminalLifecycleEvent, LifecycleKind};
    use openhub_terminal::TerminalDriver as TerminalDriverTrait;
    use openhub_terminal::error::TerminalError as TermError;
    ...
    impl TerminalDriverTrait for FakeDriver {
        ...
        async fn describe(&self, _id: i64) -> Result<Option<openhub_terminal::TerminalDescription>, TermError> {
            unimplemented!()
        }
    ...
    impl TerminalDriverTrait for CapturingDriver {
        ...
        async fn describe(&self, _id: i64) -> Result<Option<openhub_terminal::TerminalDescription>, TermError> {
            Ok(Some(openhub_terminal::TerminalDescription {
                user_id: "u1".into(),
                cwd: ".".into(),
                command: "$SHELL".into(),
                args: vec![],
    ...
    fn msg_row(position: &str, hidden: bool, r#type: &str, text: &str) -> openhub_db::models::MessageRow {
    ...
    struct StubConvRepo {
        row: Option<openhub_db::models::ConversationRow>,
        messages: Vec<openhub_db::models::MessageRow>,
    }

    #[async_trait]
    impl IConversationRepository for StubConvRepo {
        async fn get(&self, _id: i64) -> Result<Option<openhub_db::models::ConversationRow>, openhub_db::DbError> {
            Ok(self.row.clone())
        }
        async fn create(&self, _row: &openhub_db::models::ConversationRow) -> Result<i64, openhub_db::DbError> {
            unimplemented!()
        }
        async fn update(
            &self,
            _id: i64,
            _updates: &openhub_db::ConversationRowUpdate,
        ...
        ) -> Result<openhub_common::PaginatedResult<openhub_db::models::ConversationRow>, openhub_db::DbError> {
            unimplemented!()
        }
        ...
        async fn get_messages(
            ...
            _page_size: u32,
            _order: SortOrder,
        ) -> Result<openhub_common::PaginatedResult<openhub_db::models::MessageRow>, openhub_db::DbError> {
        ...
        async fn insert_message(&self, _message: &openhub_db::models::MessageRow) -> Result<(), openhub_db::DbError> {
            unimplemented!()
        }
        async fn update_message(
            &self,
            _id: &str,
            _updates: &openhub_db::MessageRowUpdate,
        ) -> Result<(), openhub_db::DbError> {
            unimplemented!()
        }
        async fn delete_messages_by_conversation(&self, _conv_id: i64) -> Result<(), openhub_db::DbError> {
            unimplemented!()
        }
        ...
        async fn search_messages(
            ...
            _page: u32,
            _page_size: u32,
        ) -> Result<openhub_common::PaginatedResult<openhub_db::MessageSearchRow>, openhub_db::DbError> {
            unimplemented!()
        }
    }

    fn conv_row(extra: &str) -> openhub_db::models::ConversationRow {
    ...
    async fn pending_signal_acp_channel_session_is_none() {
        ...
        let row = openhub_db::models::ConversationRow {
