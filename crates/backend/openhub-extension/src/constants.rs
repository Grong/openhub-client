...
pub const EXTENSION_MANIFEST_FILE: &str = "openhub-extension.json";
...
pub const RESERVED_NAME_PREFIXES: &[&str] = &["openhub-", "internal-", "builtin-", "system-"];
...
/// Well-known skill source name for theopenhubskills market.
pub const SKILLS_MARKET_NAME: &str = "openhub-skills";

/// Well-known skill source path for theopenhubskills market.
///
...
pub const SKILLS_MARKET_PATH: &str = "https://github.com/openhub/openhub-skills";
...
mod tests {
    ...
    fn test_manifest_file_name() {
        assert_eq!(EXTENSION_MANIFEST_FILE, "openhub-extension.json");
    }

    #[test]
    fn test_reserved_prefixes_contains_expected() {
        assert!(RESERVED_NAME_PREFIXES.contains(&"openhub-"));
