...
///
/// Mirrors the strategy used by `openhub-assistant::builtin`: the corpus is
/// authoritative at build time; an optional on-disk override
/// (`OPENHUB_BUILTIN_SKILLS_PATH`) is consulted at runtime for rapid
/// iteration and E2E fixtures.
static BUILTIN_SKILLS: Dir<'static> =
    include_dir!("$CARGO_MANIFEST_DIR/../openhub-app/assets/builtin-skills");
...
pub const BUILTIN_SKILLS_ENV_VAR: &str = "OPENHUB_BUILTIN_SKILLS_PATH";
...
pub struct SkillPaths {
    /// Root data directory (~/.openhub/).
    pub data_dir: PathBuf,
    /// User-created skills directory (~/.openhub/skills/).
    pub user_skills_dir: PathBuf,
    /// Per-job cron skills directory (~/.openhub/cron/skills/).
    ...
    /// Assistant-level rules directory (~/.openhub/assistant-rules/).
    pub assistant_rules_dir: PathBuf,
    /// Assistant-level skills directory (~/.openhub/assistant-skills/).
...
///
/// `data_dir` is the user-level data root (e.g. `~/.openhub/`) and
