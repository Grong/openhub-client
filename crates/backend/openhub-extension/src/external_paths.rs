...
///
/// Data is stored in `~/.openhub/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable theopenhubskills market by adding it to external paths.
    ...
    /// Disable theopenhubskills market by removing it from external paths.
