...
use openhub_ai_agent::openhub_config;
use openhub_ai_agent::{one_shot_completion, resolve_provider_config, user_message};
...
impl LiveCompanionCompleter {
    async fn resolve(&self, provider_id: &str, model: &str) -> Result<openhub_config::config::Config, AppError> {
