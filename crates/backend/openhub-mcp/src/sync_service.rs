...
use dashmap::DashMap;
use openhub_api_types::{DetectedMcpServerEntry, DetectedMcpServerResponse};
...
fn detected_to_response(detected: DetectedServer) -> DetectedMcpServerEntry {
    ...
    DetectedMcpServerEntry {
        server: openhub_api_types::McpServerResponse {
            ...
            tools: None,
            last_test_status: openhub_common::McpServerStatus::Disconnected,
            last_connected: None,
            original_json: None,
            builtin: false,
            created_at: 0,
