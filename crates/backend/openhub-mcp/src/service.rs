...
use openhub_common::now_ms;
use openhub_db::{CreateMcpServerParams, IMcpServerRepository, UpdateMcpServerParams};
...
mod tests {
    use super::*;
    use openhub_api_types::{ImportMcpServerRequest, McpTransport};
    use openhub_common::{McpServerStatus, TimestampMs};
    use openhub_db::models::McpServerRow;
    use openhub_db::{CreateMcpServerParams, DbError, UpdateMcpServerParams};
    ...
    async fn persist_test_result_records_success_status_and_tools() {
        ...
        let result = McpConnectionTestResult {
            success: true,
            tools: Some(vec![openhub_api_types::McpToolResponse {
                name: "read_file".into(),
        ...
        assert_eq!(updated.last_test_status, openhub_common::McpServerStatus::Connected);
    ...
    async fn persist_test_result_records_error_and_clears_tools() {
        ...
        let updated = svc.get_server(&created.id.to_string()).await.unwrap();
        assert_eq!(updated.last_test_status, openhub_common::McpServerStatus::Error);
