//! Integration tests for openhub-mcp core types.
//!
...
use openhub_mcp::{McpServer, McpServerTransport, McpTool};
...
fn tool_fields_preserved_through_conversion() {
    ...
    // Domain -> API response
    let resp: openhub_api_types::McpToolResponse = tool.clone().into();
