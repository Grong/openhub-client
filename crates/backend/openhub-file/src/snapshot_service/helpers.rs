...
use openhub_common::{AppError, FileChangeOperation};
...
pub(super) const SNAPSHOT_DIR_PREFIX: &str = "openhub-snapshot-";
...
const SNAPSHOT_SIG_NAME: &str = "openhub";
/// Signature email used for snapshot commits.
const SNAPSHOT_SIG_EMAIL: &str = "snapshot@openhub.local";
...
pub(super) struct WorkspaceState {
    ...
    /// - snapshot mode: `/tmp/openhub-snapshot-{hash}` (bare-style git dir).
