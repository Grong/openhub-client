...
use openhub_db::models::CronJobRow;
use openhub_db::{DbError, ICronRepository, SqliteCronRepository, UpdateCronJobParams, init_database_memory};

async fn repo() -> (Arc<dyn ICronRepository>, openhub_db::Database) {
