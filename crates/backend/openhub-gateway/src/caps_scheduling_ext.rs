...
use openhub_api_types::IdmmTargetKind;
...
struct CronGetJobParams {
    /// The id of the cron job to retrieve (from openhub_cron_list).
    job_id: String,
}
...
pub(crate) fn register(out: &mut Vec<Capability>) {
    ...
    out.push(Capability::new::<RequirementResumeTagParams, _, _>(
        CapabilityMeta::new(
            "openhub_requirement_resume_tag",
            "requirement",
