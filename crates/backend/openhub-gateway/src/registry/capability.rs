...
pub struct CapabilityMeta {
    /// MCP tool name. Convention: `openhub_<domain>_<verb_object>`, lower_snake,
    /// kept concise. The fully-namespaced wire name is `mcp__openhub-desktop__<name>`
...
pub struct Capability {
    ...
    /// incremental progress (e.g. `openhub_agent_run`); consumed by
