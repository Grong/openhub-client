...
struct CompanionGetParams {
    /// The companion id to retrieve (from openhub_companion_list).
    id: String,
}
...
struct CompanionUpdateParams {
    /// The companion id to update (from openhub_companion_list).
    id: String,
...
struct CompanionDecideSuggestionParams {
    /// The suggestion id to act on (from openhub_companion_list_suggestions).
    id: String,
...
pub(crate) fn register(out: &mut Vec<Capability>) {
    ...
    out.push(Capability::new::<CompanionCreateParams, _, _>(
        CapabilityMeta::new(
            "openhub_companion_create",
            "companion",
            "Create a new digital companion with a name and character description. The model must be configured separately via openhub_companion_update.",
            DangerTier::Write,
        ),
    ...
    out.push(Capability::new::<CompanionUpdateConfigParams, _, _>(
        CapabilityMeta::new(
            "openhub_companion_update_config",
            "companion",
    ...
    out.push(Capability::new::<CompanionListSuggestionsParams, _, _>(
        CapabilityMeta::new(
            "openhub_companion_list_suggestions",
            "companion",
    ...
    out.push(Capability::new::<CompanionDecideSuggestionParams, _, _>(
        CapabilityMeta::new(
            "openhub_companion_decide_suggestion",
            "companion",
