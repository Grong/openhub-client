...
pub const TURN_WRITEBACK_SYSTEM: &str = "You are a knowledge-base curator for OpenHub. \
...
pub const TURN_WRITEBACK_MERGE_SYSTEM: &str = "You are a careful markdown editor for OpenHub knowledge bases. \
    ...
    fn prompt_labels_eagerness_without_changing_placement() {
        let prompt = build_turn_writeback_prompt(
            &[KnowledgeMountInfo {
                id: "kb1".into(),
                name: "Ops".into(),
                rel_path: ".openhub/knowledge/Ops".into(),
