...
```bash
mkdir -p ~/.config/openhub-skills
curl -s https://skills.openhub.dev/SKILL.md > ~/.config/openhub-skills/SKILL.md
```

### Step 2 — Register your agent

Read `~/.config/openhub-skills/SKILL.md` and follow the **Registration** section
