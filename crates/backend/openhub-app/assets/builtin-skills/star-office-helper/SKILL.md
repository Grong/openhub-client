...
Star Office UI is a **third-party** local visualization companion for OpenClaw / OpenHub.
...
- It is **not** built-in to OpenHub — it runs as a separate local service (default `http://127.0.0.1:19000`).
