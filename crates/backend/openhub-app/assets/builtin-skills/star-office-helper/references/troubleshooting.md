...
## 3. OpenHub connected but preview does not move

Cause:

- OpenHub can talk to OpenClaw, but Star Office is only a visualization layer.
...
3. Confirm OpenHub preview panel URL exactly matches frontend URL.
...
- In OpenHub preview panel, use frontend URL.
