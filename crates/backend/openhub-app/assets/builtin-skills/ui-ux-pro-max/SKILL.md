...
```bash
python3 .openhub/skills/ui-ux-pro-max/scripts/search.py "saas dashboard enterprise" --domain product
python3 .openhub/skills/ui-ux-pro-max/scripts/search.py "glassmorphism minimal" --domain style
python3 .openhub/skills/ui-ux-pro-max/scripts/search.py "healthcare calm trust" --domain color
python3 .openhub/skills/ui-ux-pro-max/scripts/search.py "layout responsive" --stack html-tailwind
python3 .openhub/skills/ui-ux-pro-max/scripts/search.py --list-domains
```
