...
impl AppConfig {
    ...
    pub fn database_path(&self) -> PathBuf {
        self.data_dir.join("openhub-backend.db")
    }
}
...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            host: openhub_common::constants::DEFAULT_HOST.to_string(),
            port: openhub_common::constants::DEFAULT_PORT,
...
pub fn derive_encryption_key(jwt_secret: &str) -> [u8; 32] {
    ...
    hasher.update(b"openhub-encryption-key:");
