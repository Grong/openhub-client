...
//! not just a OpenHub-managed terminal — picks up knowledge_search / knowledge_read
...
const SERVER_NAME: &str = "openhub-knowledge";
...
/// Remove the `openhub-knowledge` server from an mcpServers-shaped JSON doc.
