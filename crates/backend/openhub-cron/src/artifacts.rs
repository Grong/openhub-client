...
use openhub_api_types::{ConversationArtifactResponse, WebSocketMessage};
use openhub_db::ConversationArtifactRow;
...
mod tests {
    ...
    fn builds_skill_suggest_response() {
        ...
        assert_eq!(response.kind, openhub_api_types::ConversationArtifactKind::SkillSuggest);
        assert_eq!(response.status, openhub_api_types::ConversationArtifactStatus::Pending);
    ...
    fn builds_cron_trigger_payload() {
        ...
        let response = artifact_response_from_row(&row).unwrap();
        assert_eq!(response.kind, openhub_api_types::ConversationArtifactKind::CronTrigger);
