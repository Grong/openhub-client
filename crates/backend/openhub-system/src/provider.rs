...
use openhub_api_types::{CreateProviderRequest, ProviderResponse, UpdateProviderRequest};
use openhub_common::{AppError, ProviderInUseDetails, decrypt_string, encrypt_string};
use openhub_db::{CreateProviderParams, IProviderRepository, UpdateProviderParams, models::Provider};
...
mod tests {
    use super::*;
    use openhub_db::{SqliteProviderRepository, init_database_memory};
    ...
    fn validate_create_bedrock_allows_empty_base_url_and_api_key() {
        let req = CreateProviderRequest {
            ...
            base_url: "".into(),
            api_key: "".into(),
            bedrock_config: Some(openhub_api_types::BedrockConfig {
                auth_method: openhub_api_types::BedrockAuthMethod::Profile,
...
mod delete_guard_tests {
    ...
    impl IProviderRepository for CountingRepo {
        async fn list(&self) -> Result<Vec<Provider>, openhub_db::DbError> {
            Ok(vec![])
        }
        async fn find_by_id(&self, _: &str) -> Result<Option<Provider>, openhub_db::DbError> {
            Ok(None)
        }
        async fn create(&self, _: openhub_db::CreateProviderParams<'_>) -> Result<Provider, openhub_db::DbError> {
            unimplemented!()
        }
        async fn update(&self, _: &str, _: openhub_db::UpdateProviderParams<'_>) -> Result<Provider, openhub_db::DbError> {
            unimplemented!()
        }
