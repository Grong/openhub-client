...
fn build_state(db: &openhub_db::Database) -> SystemRouterState {
...
async fn setup() -> (axum::Router, openhub_db::Database) {
...
async fn create_one(db: &openhub_db::Database) -> (serde_json::Value, String) {
