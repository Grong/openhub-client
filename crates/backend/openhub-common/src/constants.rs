...
pub const OPENHUB_TIMESTAMP_SEPARATOR: &str = "_openhub_";
pub const OPENHUB_FILES_MARKER: &str = "[[NOMI_FILES]]";
...
pub const COOKIE_NAME: &str = "openhub-session";
pub const COOKIE_MAX_AGE_DAYS: u32 = 30;
pub const CSRF_COOKIE_NAME: &str = "openhub-csrf-token";
