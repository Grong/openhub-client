...
// Backend crates reach the agent (openhub-*) layer ONLY through openhub-ai-agent.
...
pub use openhub_agent::companion_tools::CompanionMemorySink;
pub use openhub_agent::companion_tools::{CompanionSkillSink, SkillListing};
pub use openhub_agent::cron_tools::{CronJobSummary, CronSink};
pub use openhub_agent::requirement_tools::RequirementSink;
pub use openhub_config;
pub use openhub_types;
