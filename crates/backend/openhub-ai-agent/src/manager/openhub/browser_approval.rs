...
//!
//! Implements the facade [`openhub_browser::BrowserApprovalGate`] for the desktop/backend
...
use openhub_browser::{ApprovalAsk, ApprovalDecision, BrowserApprovalGate};
use openhub_protocol::events::ToolCategory;
use openhub_protocol::{ToolApprovalManager, ToolApprovalResult};
use openhub_common::{Confirmation, ConfirmationOption, generate_id};
use serde_json::json;
...
mod tests {
    use super::*;
    use openhub_browser::ApprovalKind;
    use openhub_protocol::commands::{ApprovalScope, SessionMode};
