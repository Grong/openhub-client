...
use openhub_common::{AppError, CommandSpec, EnvVar, ErrorChain};
use tokio::fs;
...
mod tests {
    ...
    fn metadata_with_backend(backend: Option<&str>) -> AgentMetadata {
        AgentMetadata {
            ...
            agent_type: openhub_common::AgentType::Acp,
            agent_source: openhub_api_types::AgentSource::Builtin,
            agent_source_info: openhub_api_types::AgentSourceInfo::default(),
            enabled: true,
            available: true,
            command: None,
            ...
            behavior_policy: openhub_api_types::BehaviorPolicy::default(),
            yolo_id: Some("full-access".into()),
            sort_order: 3110,
            handshake: openhub_api_types::AgentHandshake::default(),
        }
    }
...
"#,
        ...
        let mut spec = openhub_common::CommandSpec {
