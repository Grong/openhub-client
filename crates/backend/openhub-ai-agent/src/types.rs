...
use openhub_common::{AgentType, ProviderWithModel};
...
pub struct NomiResolvedConfig {
    ...
    pub extra_mcp_servers: HashMap<String, openhub_config::config::McpServerConfig>,
    ...
    pub goal: Option<openhub_agent::goal::runtime::GoalSpec>,
...
mod tests {
    ...
    #[test]
    fn openhub_build_extra_serde_with_overrides() {
        let json = json!({
    ...
    #[test]
    fn openhub_build_extra_serde_with_preset_rules() {
        let json = json!({
