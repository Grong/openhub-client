...
//! trait lives in `openhub-terminal` (the lower crate), this crate provides the
//! provider-backed implementation, and `openhub-app` wires it via
...
use openhub_terminal::TerminalTitleCompleter;
