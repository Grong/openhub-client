...
/// Wired up by `openhub-app` so deleting a conversation tears down its
/// agent process. Without this hook, ACP/openhub/nanobot subprocesses keep
...
mod tests {
    ...
    use openhub_common::{AgentKillReason, AgentType, ConversationStatus, ProviderWithModel};
