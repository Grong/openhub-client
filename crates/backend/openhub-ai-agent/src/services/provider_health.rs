...
use openhub_db::{IModelProfileRepository, IProviderRepository, models::Provider};
use regex::Regex;
...
impl ProviderHealthCheckService {
    ...
    pub async fn health_check(
        ...
        let task = req
            ...
            .unwrap_or_else(|| {
                openhub_api_types::derive_tasks_and_traits(&row.platform, model)
                    .0
                    .first()
                    .copied()
    ...
    fn resolve_probe_config(
        ...
        Ok(NomiResolvedConfig {
            ...
            context_limit: None,
            compat_overrides,
            session_directory: self.data_dir.join("openhub-health-check-sessions"),
            session_mode: None,
