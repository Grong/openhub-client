...
use openhub_api_types::AgentStreamErrorData;
use openhub_common::{ConversationStatus, TimestampMs, now_ms};
...
impl AgentRuntime {
    ...
    /// Only intended for multi-turn agents (e.g. openhub) where the same
