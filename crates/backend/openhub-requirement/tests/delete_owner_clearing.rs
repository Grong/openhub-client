...
use openhub_api_types::{AutoWorkTargetKind, CreateRequirementRequest, RequirementStatus};
...
use openhub_requirement::{RequirementEventEmitter, RequirementService};
use openhub_terminal::{TerminalEventEmitter, TerminalService};
...
async fn deleting_terminal_clears_requirement_owner_via_hook() {
    ...
    // Terminal service wired exactly as `openhub-app::build_terminal_state` does:
