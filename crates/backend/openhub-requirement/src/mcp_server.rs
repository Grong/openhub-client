...
use openhub_api_types::RequirementStatus;
use openhub_common::generate_id;
...
mod tests {
    ...
    use openhub_db::{SqliteRequirementRepository, init_database_memory};
    ...
    async fn service_with_claimed_req() -> (Arc<RequirementService>, i64) {
        ...
        let repo: Arc<dyn openhub_db::IRequirementRepository> =
