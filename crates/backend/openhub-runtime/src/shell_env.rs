...
#[cfg(unix)]
const PATH_PROBE_BEGIN: &str = "__OPENHUB_PATH_BEGIN__";
#[cfg(unix)]
const PATH_PROBE_END: &str = "__OPENHUB_PATH_END__";

/// Shell snippet that prints the live `$PATH` wrapped in our markers.
#[cfg(unix)]
const PATH_PROBE_SNIPPET: &str = "printf '__OPENHUB_PATH_BEGIN__%s__OPENHUB_PATH_END__' \"$PATH\"";
