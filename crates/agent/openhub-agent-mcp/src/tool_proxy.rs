...
use openhub_types::tool::{JsonSchema, ToolImage, ToolResult};
...
/// `openhub-tools` `read.rs` `MAX_IMAGE_BYTES` (5 MiB). We estimate the decoded
...
pub fn register_mcp_tools(
    registry: &mut openhub_tools::registry::ToolRegistry,
    manager: &Arc<McpManager>,
...
mod tests {
    ...
    use openhub_config::config::TransportType;
    use serde_json::json;
