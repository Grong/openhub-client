...
use openhub_agent::orchestration::{execute_tool_calls, execute_tool_calls_with_approval};
use openhub_compact::CompactionLevel;
use openhub_config::hooks::{HookDef, HookEngine, HooksConfig};
...
async fn test_protocol_execution_stops_after_sequential_error() {
    ...
    let approval_manager = Arc::new(openhub_protocol::ToolApprovalManager::new());
