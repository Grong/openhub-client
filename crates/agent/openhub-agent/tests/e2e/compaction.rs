...
use openhub_agent::orchestration::execute_tool_calls;
use openhub_agent::output::OutputSink;
use openhub_agent::output::null_sink::NullSink;
use openhub_compact::CompactionLevel;
...
fn openai_config(api_key: &str) -> Config {
    Config {
        ...
        compact: openhub_config::compact::CompactConfig::default(),
        plan: openhub_config::plan::PlanConfig::default(),
        file_cache: openhub_config::file_cache::FileCacheConfig::default(),
        hooks: HooksConfig::default(),
        bedrock: None,
        vertex: None,
        mcp: McpConfig::default(),
        logging: openhub_config::logging::LoggingConfig::default(),
    }
}
...
impl openhub_tools::Tool for FixedOutputTool {
    fn name(&self) -> &str {
        &self.name
    }
