...
//! self-contained in the agent layer (writes via `openhub_memory`); the host wires
...
use openhub_memory::index::append_index_entry;
use openhub_memory::paths::ENTRYPOINT_NAME;
use openhub_memory::store::write_memory;
...
impl Tool for RememberTool {
    ...
    fn describe(&self, input: &Value) -> String {
        ...
        format!("Remember: {}", openhub_tools::truncate_utf8(title, 60))
    }
}
