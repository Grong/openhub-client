...
use openhub_skills::context_modifier::ContextModifier;
use openhub_skills::executor::{execute_fork, prepare_inline_content};
use openhub_skills::hooks::{parse_skill_hooks, to_hook_defs};
use openhub_skills::permissions::{SkillPermission, SkillPermissionChecker};
use openhub_skills::types::{ExecutionContext, SkillMetadata};
...
impl Tool for SkillTool {
    ...
    fn context_modifier_for(&self, input: &serde_json::Value) -> Option<ContextModifier> {
        ...
        openhub_skills::context_modifier::from_skill(skill)
    }
...
mod tests {
    use super::*;
    use openhub_skills::permissions::SkillPermissionChecker;
    use openhub_skills::types::{ExecutionContext, LoadedFrom, SkillSource};
    use serde_json::json;
...
mod supplemental_tests {
    ...
    use openhub_skills::permissions::SkillPermissionChecker;
    use openhub_skills::types::{ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
