...
// Re-export the skills crate so existing callers (openhub-cli, tests) can use
// `openhub_agent::skills::` without changing their import paths.
pub use openhub_skills as skills;
