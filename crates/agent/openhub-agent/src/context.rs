...
use openhub_memory::prompt::{CITATION_CONTRACT, build_memory_prompt_minimal};
use openhub_skills::prompt::format_skills_within_budget;
use openhub_skills::types::SkillMetadata;
...
pub fn build_system_prompt(
    ...
    if toon_enabled {
        let toon_section = cache
            .sections
            .entry("toon")
            .or_insert_with(|| openhub_compact::toon_format_instructions().to_string());
