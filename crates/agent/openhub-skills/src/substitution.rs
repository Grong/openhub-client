...
mod tests {
    ...
    #[test]
    fn test_openhub_skill_dir_substitution() {
        let result =
    ...
    #[test]
    fn test_openhub_session_id_substitution() {
        let result =
...
mod supplemental_tests {
    ...
    fn tc_6_1_skill_dir_replaced() {
        let r = substitute_arguments(
            ...
            None,
            &[],
            Some("/home/user/.openhub/skills/my-skill"),
            None,
        );
        assert_eq!(r, "cd /home/user/.openhub/skills/my-skill");
    }
