...
// Re-export from openhub-types so callers can use a single import path
pub use openhub_types::skill_types::{ContextModifier, effort_to_string};
...
mod tests {
    ...
    use openhub_types::skill_types::EffortLevel;
