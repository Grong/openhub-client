...
// AC-14: legacy command files from .openhub/commands/ are loaded as SkillDefinition
// ---------------------------------------------------------------------------
...
async fn tc_e2e_11_legacy_commands_loaded() {
    ...
    let skill = skills
        ...
        .expect("legacy-cmd should be loaded from flat .md file in .openhub/commands/");
