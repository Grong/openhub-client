...
// Re-export EffortLevel from openhub-types (single source of truth)
pub use openhub_types::skill_types::EffortLevel;
...
pub enum SkillSource {
    /// `<config_dir>/openhub/skills/`
    User,
    /// .openhub/skills/ (project-level)
    Project,
    /// .openhub/.managed/skills/
    Managed,
    /// Built-in bundled skills
    Bundled,
    /// Loaded via MCP protocol
    Mcp,
    /// .openhub/commands/ (legacy compatibility)
    Legacy,
}
