...
///
/// Examples:
/// - base=`<config_dir>/openhub/skills`, target=`<config_dir>/openhub/skills/db/migrate` → `"db:migrate"`
/// - base=`<config_dir>/openhub/skills`, target=`<config_dir>/openhub/skills/my-skill` → `"my-skill"`
