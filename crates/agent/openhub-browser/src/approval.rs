...
//!    adapts this trait to the engine's [`openhub_browser_engine::firewall::EgressApprover`]).
//!
...
//! gateway (the GW2 `openhub_browser_confirm` pending channel).
//!
//! # Security keystone
//!
...
use openhub_browser_engine::firewall::{EgressApprover, EgressVerdict, PostPreview};
