...
pub struct CompactConfig {
    ...
    #[serde(default)]
    pub compaction: openhub_compact::CompactionLevel,
...
impl Default for CompactConfig {
    fn default() -> Self {
        Self {
            ...
            compaction: openhub_compact::CompactionLevel::default(),
            toon: false,
        }
    }
}
...
"#;
    ...
    fn default_compaction_is_safe() {
        let cfg = CompactConfig::default();
        assert_eq!(cfg.compaction, openhub_compact::CompactionLevel::Safe);
    }
    ...
    fn toml_compaction_level_override() {
        ...
        let cfg: CompactConfig = toml::from_str(toml_str).unwrap();
        assert_eq!(cfg.compaction, openhub_compact::CompactionLevel::Full);
    }
    ...
    fn toml_compaction_off() {
        ...
        let cfg: CompactConfig = toml::from_str(toml_str).unwrap();
        assert_eq!(cfg.compaction, openhub_compact::CompactionLevel::Off);
    }
