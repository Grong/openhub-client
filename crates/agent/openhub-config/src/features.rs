//! Feature-flag registry for the openhub-agent overhaul (staged rollout).
//!
...
//! docs/superpowers/specs/2026-06-21-openhub-agent-overhaul-design.md §6.
...
pub const FEATURES: &[FeatureSpec] = &[
    FeatureSpec {
        ...
        key: "openhub_cooperative_cancel",
        stage: Stage::UnderDevelopment,
        default_enabled: false,
    },
    FeatureSpec {
        id: Feature::TerminationGuard,
        key: "openhub_termination_guard",
        stage: Stage::UnderDevelopment,
        default_enabled: false,
    },
];
...
mod tests {
    ...
    fn from_sources_applies_known_overrides() {
        let f = Features::from_sources(
            ...
            [("openhub_cooperative_cancel".to_string(), true)],
        );
        assert!(f.is_enabled(Feature::CooperativeCancel));
    }
