...
**Files:**
- Modify: `ui/src/renderer/pages/conversation/platforms/openhub/NomiSendBox.tsx`（props + `rightTools` 778-797）
...
```bash
git add ui/src/renderer/pages/conversation/platforms/openhub/NomiSendBox.tsx ui/src/renderer/pages/conversation/components/ChatConversation.tsx
