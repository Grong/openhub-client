 ...
 * <OpenHubScrollArea className="h-400px">
 *   <div>Content...</div>
 * </OpenHubScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <OpenHubScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </OpenHubScrollArea>
 *
 * // 双向滚动 / Both directions
 * <OpenHubScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </OpenHubScrollArea>
 * ```
 */
interface OpenHubScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const OpenHubScrollArea: React.FC<OpenHubScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
OpenHubScrollArea.displayName = 'OpenHubScrollArea';

export default OpenHubScrollArea;
