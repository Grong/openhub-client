...
type OpenHubSelectSize = NativeSelectSize | 'middle';

export interface OpenHubSelectProps extends NativeSelectProps {
  /** 额外的类名 / Additional class name */
  className?: string;
  /** 统一尺寸，新增 middle（32px）/ Unified size with additional "middle" (32px) */
  size?: OpenHubSelectSize;
}
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <OpenHubSelect placeholder="请选择" style={{ width: 200 }}>
 *   <OpenHubSelect.Option value="1">选项1</OpenHubSelect.Option>
 *   <OpenHubSelect.Option value="2">选项2</OpenHubSelect.Option>
 * </OpenHubSelect>
 *
 * // 多选 / Multiple selection
 * <OpenHubSelect mode="multiple" placeholder="请选择多个">
 *   <OpenHubSelect.Option value="1">选项1</OpenHubSelect.Option>
 *   <OpenHubSelect.Option value="2">选项2</OpenHubSelect.Option>
 * </OpenHubSelect>
 *
 * // 分组 / Grouped options
 * <OpenHubSelect placeholder="请选择">
 *   <OpenHubSelect.OptGroup label="分组1">
 *     <OpenHubSelect.Option value="1">选项1</OpenHubSelect.Option>
 *   </OpenHubSelect.OptGroup>
 *   <OpenHubSelect.OptGroup label="分组2">
 *     <OpenHubSelect.Option value="2">选项2</OpenHubSelect.Option>
 *   </OpenHubSelect.OptGroup>
 * </OpenHubSelect>
 * ```
 ...
 */
const mapSizeToNative = (size?: OpenHubSelectSize): NativeSelectSize | undefined => {
  if (!size) return undefined;
  if (size === 'middle') return 'default';
  return size;
};

type OpenHubSelectComponent = React.ForwardRefExoticComponent<OpenHubSelectProps & React.RefAttributes<SelectHandle>> & {
  Option: typeof Select.Option;
  OptGroup: typeof Select.OptGroup;
};

const InternalSelect = React.forwardRef<SelectHandle, OpenHubSelectProps>(
...
const OpenHubSelect = InternalSelect as OpenHubSelectComponent;

OpenHubSelect.displayName = 'OpenHubSelect';

// 导出子组件 / Export sub-components
OpenHubSelect.Option = Select.Option;
OpenHubSelect.OptGroup = Select.OptGroup;

export default OpenHubSelect;
