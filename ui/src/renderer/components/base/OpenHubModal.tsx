...
/** OpenHubModal 组件 Props */
export interface OpenHubModalProps extends Omit<ModalProps, 'title' | 'footer'> {
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <OpenHubModal visible={true} onCancel={handleClose} header="标题">
 *   内容
 * </OpenHubModal>
 *
 * // 预设尺寸 / Preset size
 * <OpenHubModal visible={true} size="large" header="大型弹窗">
 *   内容
 * </OpenHubModal>
 *
...
const OpenHubModal: React.FC<OpenHubModalProps> = ({
  children,
  size,
  header,
  footer,
...
OpenHubModal.displayName = 'OpenHubModal';

export default OpenHubModal;
