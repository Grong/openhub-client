 ...
 */
export interface OpenHubCollapseProps {
 ...
 */
export interface OpenHubCollapseItemProps {
 ...
 */
const OpenHubCollapseItem: React.FC<OpenHubCollapseItemProps> = ({ children }) => <>{children}</>;
OpenHubCollapseItem.displayName = 'OpenHubCollapseItem';
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <OpenHubCollapse defaultActiveKey={['1']}>
 *   <OpenHubCollapse.Item name="1" header="面板1">
 *     内容1
 *   </OpenHubCollapse.Item>
 *   <OpenHubCollapse.Item name="2" header="面板2">
 *     内容2
 *   </OpenHubCollapse.Item>
 * </OpenHubCollapse>
 *
 * // 手风琴模式 / Accordion mode
 * <OpenHubCollapse accordion defaultActiveKey="1">
 *   <OpenHubCollapse.Item name="1" header="面板1">内容1</OpenHubCollapse.Item>
 *   <OpenHubCollapse.Item name="2" header="面板2">内容2</OpenHubCollapse.Item>
 * </OpenHubCollapse>
 *
 * // 自定义图标 / Custom icon
 * <OpenHubCollapse
 ...
 * ```
 */
const OpenHubCollapseComponent: React.FC<OpenHubCollapseProps> & { Item: typeof OpenHubCollapseItem } = ({
  children,
  className,
  defaultActiveKey,
  activeKey,
  ...
  const items = useMemo(() => {
    return React.Children.toArray(children).filter((child): child is React.ReactElement<OpenHubCollapseItemProps> => {
      return React.isValidElement(child) && child.type === OpenHubCollapseItem;
    });
  }, [children]);
...
OpenHubCollapseComponent.Item = OpenHubCollapseItem;

export default OpenHubCollapseComponent;
