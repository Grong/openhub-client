...
const GuidInputCard: React.FC<GuidInputCardProps> = ({
  ...
  return (
    <div
      className={`${styles.guidInputCardWrap} guid-input-card-shell relative flex flex-col ${mentionOpen ? 'overflow-visible' : 'overflow-hidden'} transition-all duration-200 ${isFileDragging ? 'b b-solid border-dashed guid-input-card-shell--dragging' : ''}`}
      style={{
        zIndex: 1,
