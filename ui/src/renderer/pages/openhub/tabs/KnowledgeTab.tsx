    ...
    <div className='flex flex-col gap-10px py-8px'>
      <div className='flex items-start gap-16px bg-fill-2 rd-10px px-14px py-12px'>
        <div className='w-200px shrink-0'>
          <div className='text-14px text-t-primary font-500'>{t('openhub.settings.knowledge')}</div>
          <div className='text-12px text-t-tertiary mt-2px'>{t('openhub.settings.knowledgeHint', { companionName })}</div>
        </div>
