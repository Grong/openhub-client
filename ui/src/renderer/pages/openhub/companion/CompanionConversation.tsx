...
import OpenHubChat from '@/renderer/pages/conversation/platforms/openhub/OpenHubChat';
...
interface Props {
  /** 该伙伴的唯一专属 openhub 会话（由 CompanionChatPanel 载入后传入）。 */
 ...
 * （MessageList 富渲染：工具卡/思考流/产物/文件变更/Markdown；OpenHubSendBox：附件 /
 ...
 *
 * 复用 OpenHubChat 自带的历史/流式（useMessageLstCache）后，旧手写面板 CompanionChat 退役。
 */
