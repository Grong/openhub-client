...
const OpenHubChat: React.FC<{
  ...
  // pages on scroll-up. The openhub surface backs both work conversations and the
  ...
  const turnActivity = useOpenHubMessage(conversation_id, {
...
export default HOC.Wrapper(MessageListProvider, MessageListLoadingProvider, LocalImageView.Provider)(OpenHubChat);
